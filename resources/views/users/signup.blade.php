...
@section('content')
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <form method="POST" action="{{ route('signup') }}" class="bg-white p-6 rounded-lg shadow-md">
            @csrf
            <p class="text-center font-bold mb-3 text-2xl">Signup</p>
            <div class="mb-4">
            ...
            <div class="mt-4 text-center">
                <p class="text-sm">Already have an account? <a href="{{ route('login') }}" class="text-blue-500">Login</a></p>
            </div>
        </form>
    </div>
@endsection